function hist_ber_actualber
  ...
  subplot(2,2,1)
  hist(ay, 10)
  title('BER = 0.0075 dla d³ugoœci sygna³u 5k')
  subplot(2,2,2)
  hist(by, 10)
  title('BER = 0.05 dla d³ugoœci sygna³u 5k')
  subplot(2,2,3)
  hist(cy, 10)
  title('BER = 0.0075 dla d³ugoœci sygna³u 10k')
  subplot(2,2,4)
  hist(dy, 10)
  title('BER = 0.05 dla d³ugoœci sygna³u 10k')
