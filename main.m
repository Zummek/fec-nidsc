...
for i=0:2000
  ...
  writeToFile([E, errAmount, BER], "data_8_247_1_0.3");    % data_BCHBAse_DataBitLength_BCHcorrection_actualBer (actual BER to prawdopodobieñstwo przek³amania tych bitów na poczatku) 
  % debugger :) 
  %disp("data: "), disp(data);
